/**
 * Se quiere recibir por comunicación UART un mensaje de 20 bits de texto de forma bloqueante.
 */
...
/**
 * Cuando se recibe el primer byte de datos, se ejecuta la interrupción UART0_IRQHandler
 * y se almacena el mensaje en la variable mensaje de forma bloqueante.
 * No se sale de la interrupción hasta que se reciban los 20 bytes.
 */
